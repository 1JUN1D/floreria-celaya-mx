        ...
        <div class="product-card" data-categories="${product.categories.join(' ')}">
            ...
            <div class="product-info">
                ...
                <div class="product-footer">
                    ...
                    <a href="https://wa.me/5214613115916?text=${encodeURIComponent('Hola, me interesa el producto: ' + product.name + ' (Ref. ' + productCode(product) + ') - ' + formatPrice(product.price) + ' | Foto: ' + productPhotoUrl(product))}" class="btn-order" target="_blank">
